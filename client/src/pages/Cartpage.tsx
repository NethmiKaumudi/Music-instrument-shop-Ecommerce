...
const CartPage: React.FC = () => {
    ...
    const handleQuantityChange = (index: number, increment: boolean) => {
        ...
        if (increment) {
            ...
            updatedCartItems[index].quantity > 1 && updatedCartItems[index].quantity--;
        }
            ...
            <div className="container mx-auto px-4 py-4 flex-grow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <table className="w-full">
                                    ...
                                    <tr key={index} className={index % 2 === 0 ? "bg-gray-100" : "bg-white"}>
                                        <td className="px-4 py-2">
                                            <div className="flex items-center">
                                                <img src={`https://via.placeholder.com/50x50?text=${item.name}`} alt={item.name} className="w-8 h-8 rounded-full mr-2" />
                                                {item.name}
                                            </div>
                                        </td>
                            ...
                            <tfoot>
                                <tr className="bg-gray-200">
                                    ...
                                    <td className="px-4 py-2 font-bold">{calculateTotalItems()}</td>
                    ...
                    <div className="bg-blue-200 shadow-md rounded-lg p-6">
                        ...
                        <p className="mb-2 text-lg">Category Count: {calculateCategoryCount()}</p>
                        <p className="mb-4 text-lg">Total Price: ${calculateTotalPrice()}</p>
                        <button
