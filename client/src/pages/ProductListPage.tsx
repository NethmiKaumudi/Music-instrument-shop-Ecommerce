...
//       <nav className="nav-bar flex items-center justify-between bg-secendaryDark text-white py-3 px-6">
//         <Link to="/" className="text-2xl font-inter flex items-center">
//           <img src={logo} alt="NKBEATS Logo" className="h-20 mr-2" /> NKBEATS
//         </Link>
//         <div className="flex items-center">
//           <span className="cart-quantity text-xs bg-secendary hover:bg-primary text-black rounded-full px-2 py-1">
//             {Object.keys(cartItems).length > 0 &&
...
//             >
//               <div className="w-full">
//                 <div className="image-container mb-4 overflow-hidden rounded-md h-48 items-center w-fit">
//                   <img
//                     src={product.image}
//                     alt={product.name}
//                     onError={handleImageError}
              ...
              <div className="w-full">
                <div className="image-container mb-4 overflow-hidden rounded-md h-48 items-center w-fit">
                  <img
                    ...
                    alt={product.name}
                    onError={handleImageError}
                    className="product-image object-cover w-full h-full hover:opacity-75 transition ease-in-out duration-300 cursor-pointer"
                  />
                </div>
                ...
                <button
                  onClick={() => addToCart(product)}
                  className="bg-primaryDark text-white px-4 py-2 rounded-lg hover:bg-primary"
                >
                  Add to Cart
                </button>
              </div>
